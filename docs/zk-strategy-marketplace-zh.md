...
```
Creator ──信号──→ Platform ──信号──→ Investor/Agent
                                │
                        手续费（业绩分成 or 月费）
                                │
                    ┌───────────┼───────────┐
